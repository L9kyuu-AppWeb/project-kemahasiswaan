...
<head>
    ...
    <title>Tambah Rekognisi - Sistem Kemahasiswaan</title>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <form action="{{ route('mahasiswa.rekognisi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" value="{{ $mahasiswa->nim }}" disabled class="w-full px-4 py-3 border rounded-lg bg-gray-100">
                            </div>
                            <div>
                                <label class="block text-gray-700 font-semibold mb-2">NIDN/NUPTK</label>
                                <input type="text" name="nidn_nuptk" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-cyan-500">
                            </div>
                            <div>
                                <label class="block text-gray-700 font-semibold mb-2">Nama Dosen</label>
                                <input type="text" name="nama_dosen" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-cyan-500">
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex gap-3 pt-6 mt-6 border-t">
                    <button type="submit" class="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-3 rounded-lg font-semibold">Simpan</button>
