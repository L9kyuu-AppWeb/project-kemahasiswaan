        ...
        <div class="bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl shadow-lg p-6 mb-6 text-white">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-cyan-100 text-sm">Kelola data rekognisi Anda</p>
                </div>
                <div class="flex gap-2">
                    <a href="{{ route('mahasiswa.rekognisi.panduan') }}"
                       class="bg-cyan-700 text-white hover:bg-cyan-600 px-6 py-3 rounded-lg transition duration-200 font-semibold flex items-center gap-2">
                        <i class="fas fa-book"></i>
                        Panduan
                    </a>
                    <a href="{{ route('mahasiswa.rekognisi.create') }}"
                       class="bg-white text-cyan-600 hover:bg-cyan-50 px-6 py-3 rounded-lg transition duration-200 font-semibold flex items-center gap-2 shadow-lg">
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-4">
                                <div class="flex gap-2">
                                    <a href="{{ route('mahasiswa.rekognisi.show', $rekognisi->id) }}"
                                    ...
                                    @if($rekognisi->status === 'pending')
                                    <a href="{{ route('mahasiswa.rekognisi.edit', $rekognisi->id) }}"
                                    ...
                                    <form action="{{ route('mahasiswa.rekognisi.destroy', $rekognisi->id) }}" method="POST" class="inline"
                                          onsubmit="return confirm('Apakah Anda yakin ingin menghapus rekognisi ini?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                        ...
                        <tr>
                            <td colspan="5" class="py-8 px-4 text-center text-gray-500">
                                ...
                                <a href="{{ route('mahasiswa.rekognisi.create') }}" class="text-cyan-600 hover:underline mt-2 inline-block">
                                    Tambah rekognisi pertama Anda
                                </a>
                            </td>
                        </tr>
                        @endforelse
