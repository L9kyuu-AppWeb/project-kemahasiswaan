...
<body class="bg-gradient-to-br from-green-50 to-emerald-100">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('mahasiswa.kompetisi.index') }}" class="group bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition duration-200 border border-gray-100">
                <div class="flex items-start gap-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition duration-200 shrink-0">
                        <i class="fas fa-medal text-white text-2xl"></i>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-800 group-hover:text-emerald-600 transition mb-1">Kompetisi & Prestasi</h3>
                        <p class="text-sm text-gray-500">Kelola data kompetisi</p>
                    </div>
                </div>
            </a>

            <a href="{{ route('mahasiswa.rekognisi.index') }}" class="group bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition duration-200 border border-gray-100">
                <div class="flex items-start gap-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition duration-200 shrink-0">
                        <i class="fas fa-award text-white text-2xl"></i>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-800 group-hover:text-indigo-600 transition mb-1">Rekognisi</h3>
                        <p class="text-sm text-gray-500">Kelola rekognisi Anda</p>
                    </div>
                </div>
            </a>

            <a href="{{ route('mahasiswa.sertifikasi.index') }}" class="group bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition duration-200 border border-gray-100">
                <div class="flex items-start gap-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-violet-500 to-purple-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition duration-200 shrink-0">
                        <i class="fas fa-certificate text-white text-2xl"></i>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-800 group-hover:text-violet-600 transition mb-1">Sertifikasi</h3>
                        <p class="text-sm text-gray-500">Kelola sertifikasi Anda</p>
                    </div>
                </div>
            </a>
