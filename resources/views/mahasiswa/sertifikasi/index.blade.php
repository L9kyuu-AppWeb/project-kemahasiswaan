            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        @empty
                        <tr><td colspan="4" class="py-8 px-4 text-center text-gray-500"><i class="fas fa-inbox text-4xl mb-3 text-gray-300"></i><p>Belum ada data sertifikasi.</p><a href="{{ route('mahasiswa.sertifikasi.create') }}" class="text-indigo-600 hover:underline mt-2 inline-block">Tambah sertifikasi pertama Anda</a></td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
