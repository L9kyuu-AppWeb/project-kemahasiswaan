...
<head>
    ...
    <title>Tambah Mahasiswa - Sistem Kemahasiswaan</title>
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Tambah Mahasiswa</h2>
                    <p class="text-gray-500 text-sm">Tambahkan mahasiswa baru ke sistem</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.mahasiswa.store') }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}"
                           ...
                           placeholder="mahasiswa@example.com" required>
                    @error('email')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
