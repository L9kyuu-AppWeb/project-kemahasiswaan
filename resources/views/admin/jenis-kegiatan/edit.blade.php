...
<head>
    ...
    <title>Edit Jenis Kegiatan - Sistem Kemahasiswaan</title>
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div><h2 class="text-2xl font-bold text-gray-800">Edit Jenis Kegiatan</h2><p class="text-gray-500 text-sm">Perbarui jenis kegiatan</p></div>
            </div>
            ...
            <form action="{{ route('admin.master-kegiatan.jenis.update', $jenisKegiatan->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama" value="{{ old('nama', $jenisKegiatan->nama) }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500" required>
