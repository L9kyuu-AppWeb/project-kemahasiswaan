    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm">Tambah kategori kegiatan umum baru</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.kategori-kegiatan-umum.store') }}" method="POST">
            @csrf
            <div class="space-y-6">
                <div>
                    <label class="block text-gray-700 font-semibold mb-2">Nama Kategori <span class="text-red-500">*</span></label>
                    <input type="text" name="nama_kategori" value="{{ old('nama_kategori') }}" class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500" required placeholder="Contoh: Seminar, Organisasi, Lomba">
