...
<head>
    ...
    <title>Edit Mahasiswa Magang - Sistem Kemahasiswaan</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl shadow-lg p-6 mb-6 text-white">
            ...
            <p class="text-emerald-100 text-sm">Formulir pengubahan data mahasiswa magang</p>
        </div>
        ...
        <!-- Form -->
        <form action="{{ route('admin.magang.update', $magang->id) }}" method="POST" class="bg-white rounded-xl shadow-md p-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <select id="mahasiswa_id" name="mahasiswa_id" required
                        ...
                        @foreach($mahasiswas as $mhs)
                            <option value="{{ $mhs->id }}" {{ old('mahasiswa_id', $magang->mahasiswa_id) == $mhs->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select id="tahun_ajar_id" name="tahun_ajar_id" required
                        ...
                        @foreach($tahunAjarList as $ta)
                            <option value="{{ $ta->id }}" {{ old('tahun_ajar_id', $magang->tahun_ajar_id) == $ta->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select id="semester" name="semester" required
                        ...
                        @for($i = 1; $i <= 10; $i++)
                            <option value="{{ $i }}" {{ old('semester', $magang->semester) == $i ? 'selected' : '' }}>
                                Semester {{ $i }}
                            </option>
                        @endfor
                    </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="nama_perusahaan" name="nama_perusahaan"
                           value="{{ old('nama_perusahaan', $magang->nama_perusahaan) }}" required
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="lokasi_perusahaan" name="lokasi_perusahaan"
                           value="{{ old('lokasi_perusahaan', $magang->lokasi_perusahaan) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="pembimbing_lapangan" name="pembimbing_lapangan"
                           value="{{ old('pembimbing_lapangan', $magang->pembimbing_lapangan) }}"
                ...
                <div>
                    ...
                    <input type="text" id="no_telp_pembimbing" name="no_telp_pembimbing"
                           value="{{ old('no_telp_pembimbing', $magang->no_telp_pembimbing) }}"
                ...
                <div>
                    ...
                    <input type="text" id="dosen_pembimbing_nama" name="dosen_pembimbing_nama"
                           value="{{ old('dosen_pembimbing_nama', $magang->dosen_pembimbing_nama) }}"
                ...
                <div>
                    ...
                    <input type="text" id="dosen_pembimbing_nik" name="dosen_pembimbing_nik"
                           value="{{ old('dosen_pembimbing_nik', $magang->dosen_pembimbing_nik) }}"
                ...
                <div>
                    ...
                    <select id="status" name="status" required
                        ...
                        <option value="tidak_aktif" {{ old('status', $magang->status) === 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
                    @error('status')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="catatan" name="catatan" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 @error('catatan') border-red-500 @enderror">{{ old('catatan', $magang->catatan) }}</textarea>
                    @error('catatan')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
