...
<head>
    ...
    <title>Tambah Pengumuman - Sistem Kemahasiswaan</title>
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Tambah Pengumuman</h2>
                    <p class="text-gray-500 text-sm">Tambahkan pengumuman baru untuk mahasiswa</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.pengumuman.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="judul" id="judul" value="{{ old('judul') }}"
                           ...
                           placeholder="Contoh: Pendaftaran Beasiswa KIP Gelombang 1" required>
                    @error('judul')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" name="tanggal_publish" id="tanggal_publish" value="{{ old('tanggal_publish', date('Y-m-d')) }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_expire" id="tanggal_expire" value="{{ old('tanggal_expire') }}"
                ...
                <div class="flex gap-3 pt-6 border-t">
                    <button type="submit" class="flex-1 bg-gradient-to-r from-orange-600 to-red-600 text-white px-6 py-3 rounded-lg hover:from-orange-700 hover:to-red-700 transition duration-200 font-semibold shadow-md">
