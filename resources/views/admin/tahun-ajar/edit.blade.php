...
<head>
    ...
    <title>Edit Tahun Ajar - Sistem Kemahasiswaan</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl shadow-lg p-6 mb-6 text-white">
            ...
            <p class="text-orange-100 text-sm">Form untuk mengedit tahun ajaran</p>
        </div>
            ...
            <form action="{{ route('admin.tahun-ajar.update', $tahunAjar->id) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $tahunAjar->nama) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="tahun_mulai" id="tahun_mulai" value="{{ old('tahun_mulai', $tahunAjar->tahun_mulai) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="tahun_selesai" id="tahun_selesai" value="{{ old('tahun_selesai', $tahunAjar->tahun_selesai) }}"
                    ...
                    <div>
                        ...
                        <select name="semester" id="semester"
                            ...
                            <option value="ganjil" {{ old('semester', $tahunAjar->semester) == 'ganjil' ? 'selected' : '' }}>Ganjil</option>
                            <option value="genap" {{ old('semester', $tahunAjar->semester) == 'genap' ? 'selected' : '' }}>Genap</option>
                        </select>
                        @error('semester')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
