    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-2xl font-bold">Edit Ruang Lingkup</h2>
                </div>
            </div>
            ...
            <form action="{{ route('admin.master-kegiatan.ruang-lingkup.update', $ruangLingkup->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-6">
                    ...
                    <input type="text" name="nama" value="{{ old('nama', $ruangLingkup->nama) }}"
