...
<head>
    ...
    <title>Tambah Program Studi - Sistem Kemahasiswaan</title>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm">Tambahkan program studi baru ke sistem</p>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="kode" id="kode" value="{{ old('kode') }}"
                               ...
                               placeholder="Contoh: TI, SI, TK" required>
                        @error('kode')
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                                  ...
                                  placeholder="Deskripsi program studi...">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
