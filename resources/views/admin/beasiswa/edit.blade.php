...
<head>
    ...
    <title>Edit Penerima Beasiswa - Sistem Kemahasiswaan</title>
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Edit Penerima Beasiswa</h2>
                    <p class="text-gray-500 text-sm">Perbarui data mahasiswa penerima beasiswa</p>
                </div>
            </div>
