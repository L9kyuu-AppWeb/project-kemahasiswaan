...
@section('title', 'Tambah Nilai Kegiatan')
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-2xl font-bold">Tambah Nilai Kegiatan</h2>
                </div>
            </div>
            ...
            <form action="{{ route('admin.master-kegiatan.nilai.store') }}" method="POST">
                @csrf
