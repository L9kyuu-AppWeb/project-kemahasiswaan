...
<head>
    ...
    <title>Edit Kategori Lomba - Sistem Kemahasiswaan</title>
        ...
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin.lomba-kategori.index') }}" class="flex items-center gap-2 hover:opacity-80 transition">
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Edit Kategori Lomba</h2>
                    <p class="text-gray-500 text-sm">Perbarui informasi kategori lomba</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.lomba-kategori.update', $lombaKategori->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $lombaKategori->nama) }}"
