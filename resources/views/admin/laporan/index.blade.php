        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <form action="{{ route('admin.laporan.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end">
                    <button type="submit"
                            class="w-full bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg transition duration-200 font-semibold flex items-center justify-center gap-2">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($mahasiswaList as $mhs)
                            <tr class="hover:bg-purple-50 transition duration-150">
                                ...
                                <td class="py-4 px-6">
                                    <a href="{{ route('admin.laporan.mahasiswa', $mhs['mahasiswa_id']) }}"
                                       class="bg-purple-100 text-purple-700 hover:bg-purple-200 px-4 py-2 rounded-lg transition duration-200 text-sm font-medium flex items-center gap-2 inline-flex">
