...
@section('title', 'Tambah Detail Kegiatan')
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h2 class="text-2xl font-bold">Tambah Detail Kegiatan</h2>
                </div>
            </div>
            ...
            <form action="{{ route('admin.master-kegiatan.detail.store') }}" method="POST">
                @csrf
                <div class="mb-6">
